...
extern "C"
{
    ...
    void init_cachesim(cachesim_word_t (*mem_read)(cachesim_addr_t addr, int len), void (*mem_write)(cachesim_addr_t addr, int len, cachesim_word_t data), int total_size_width, int associativity_width);
